...
\input{my_chapters/1_introduction.tex}
\input{my_chapters/2_background.tex}
\input{my_chapters/3_system_design.tex}
\input{my_chapters/4_post_processing.tex}
\input{my_chapters/5_experimental_setup.tex}
\input{my_chapters/6_results_and_analysis.tex}
\input{my_chapters/7_conclusion.tex}
