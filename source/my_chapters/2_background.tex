...
\begin{table}
    \begin{center}
    \caption{Tomato mapping results.}
...
\begin{figure}
	\centering
    \includegraphics[height=2.5in]{figures/latitudelongitude.jpg}
