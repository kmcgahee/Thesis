...
%Restate main thesis point and if supported or not.  
% - Couple general statements supporting this.
% - Don't simply repeat things that were in your paper. They have read it
% - can be extended to more than just robot. 

%Answer the question "So What?"
%Show your readers why this paper was important. Show them that your paper was meaningful and useful.
% - make your conclusion go from specific to general. Think globally.

%My summary/interpretation of the results. Important to be in the field.  Get feedback in real-time.  Manual-based %trigger mapping.

%7.3.	Recommendations
%7.3.1.	Paying close attention to camera settings.
%7.3.2.	Using Tags instead of sticks.  Space out more. 
